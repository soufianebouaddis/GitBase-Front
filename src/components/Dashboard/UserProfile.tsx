        ...
        <div className="flex items-center space-x-4">
            <div className="relative">
                {user.profilePictureUrl ? (
                    <img
                        className="h-8 w-8 rounded-lg border-2 border-gitbase-primary shadow-md object-cover"
                        src={user.profilePictureUrl}
                        alt={user.name}
                        referrerPolicy="no-referrer"
                    />
                ) : (
                    <div className="h-8 w-8 rounded-lg border-2 border-gitbase-primary shadow-md bg-gitbase-secondary flex items-center justify-center">
